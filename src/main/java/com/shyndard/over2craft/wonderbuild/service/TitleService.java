...
public class TitleService {
	...
	public void sendToAll(String title, String subtitle, int fadeInTime, int showTime, int fadeOutTime) {
		Bukkit.getOnlinePlayers().forEach(player -> {
			send(player, title, subtitle, fadeInTime, showTime, fadeOutTime);
		});
	}
